          ...
          <div class="form">
		          ...
		          <form name="loginForm" action="/memberlogin" method="post">
		             <div class="text">
		              ...
		              <input id="email" class="login_input" type="email" placeholder="e-mail" maxlength="28" name="User_id" onblur="checkNotEmpty()"  onmousedown="removespan()"/><br />
		              <span id="emailspan"></span><br>
		         
		              <input id="pw"  class="login_input" class="input password" type="password" placeholder="password" maxlength="20"  name="User_password" onblur="checkNotEmptyPW()" onmousedown="remove()"/><br />
