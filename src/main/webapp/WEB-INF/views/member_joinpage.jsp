...
<div class="login_info_inner_size"><h3 class="join_h3">로그인정보</h3>
       <div class="form-group required">
              ...
              <input type="email" class="form-control" id="registration-form-email" name="id" onblur="emailCheck()"/><br>
       ...
       <div class="form-group required" class="showPW">
              <label class="form-control-label">비밀번호*<br />
                <input type="password" name="password" class="form-control" id="registration-form-password" onblur="passCheck()" onblur="passValidCheck()" /><br>
                <!-- 아이콘 -->
...
<div class="personal_info_inner_size"><h3 class="join_h3">개인정보</h3>
        <div class="form-group required">
              <label class="form-control-label">이름 *<br />
                <input type="text" name="name" maxlength="7" class="form-control" id="registration-form-fname" onblur="fnameCheck()"/><br>
                  <span class="hiddenText"  id="spanfirstname"></span>
              </label>
        </div>
        <div class="form-group required">
              <label class="form-control-label">연락처 *<br />
	                <input type="text" name="phone" class="form-control" maxlength="11" placeholder="'-'제외하고 입력해 주십시오." id="phone" onblur="phoneCheck()"/><br>
         ...
         <div>
           <label class="form-control-label">생일(선택 사항)</label><br />
           <!-- <input type="text" id="datepicker"> -->
           <select id="join_select" name="birthMonth">
   ...
   <!-- https://eugene-kim.tistory.com/74 체크박스 value값 DB저장 -->
	        <div>
	          <input type="checkbox" class="checkbox" name="interest" id="checkbox1" value="ring"/>
	          <label for="preferences_ring" class="checkbox-label">반지</label>
	        </div>
	        <div>
	          <input type="checkbox" class="checkbox" name="interest" id="checkbox2" value="necklace"/>
	          <label for="preferences_necklace" class="checkbox-label">목걸이</label>
	        </div>
	        <div>
	          <input type="checkbox" class="checkbox" name="interest" id="checkbox3" value="earring"/>
	          <label for="preferences_earring" class="checkbox-label" >귀걸이</label>
	        </div>
	        <div>
	          <input type="checkbox" class="checkbox" name="interest" id="checkbox4" value="bracelet"/>
	          <label for="preferences_bracelet" class="checkbox-label">팔찌</label>
	        </div>
	        <div>
	          <input type="checkbox" class="checkbox" name="interest" id="checkbox5" value="anklet"/>
